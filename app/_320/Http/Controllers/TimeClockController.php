   ...
   public function index(Request $request){
    ...
    public function time_clock_data_week(Request $request){
        ...
        $sql="select user_id,mu.vfname empname,
            ...
            max(case when DAYNAME(logout_time) = 'Friday' then logout_time else null end) fri_login,
          ...
          $html='';
            ...
            foreach($data['week_list'] as $week_list){
                 ...
                 <td class="emp_bg bordr_set  "> <span class="normal_text">  '.$week_list->empname.'</span> <input type="hidden"  name="emp_id[]" value="'.$week_list->user_id.'"  ></span></td></td>';
