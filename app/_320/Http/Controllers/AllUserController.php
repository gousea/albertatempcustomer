...
class AllUserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('_310.User.index', compact('users'));
    }
    ...
    public function create()
    {
        ...
        return view('_310.User.create', compact('permissions', 'mstPermissiongroup'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (isset($duplicateUserid) && count($duplicateUserid) > 0) {
            ...
            return redirect('310/users/create')
        ...
        return redirect('310/users')->with('message', 'User Created Successfully');
    }
    ...
    public function edit(UserDynamic $userDynamic, $iuserid)
    {
        ...
        return view('_310.User.edit', compact('permissions', 'mstPermissiongroup', 'users', 'dataPerCheck'));
    }
    ...
    public function update(Request $request, UserDynamic $userDynamic, $iuserid)
    {
        ...
        if (isset($duplicateUserid) && count($duplicateUserid) > 0) {
            ...
            fwrite($myfile, $store_text);
             ...
             return redirect('310/users/'.$iuserid.'/edit')
                ->withErrors("Pos User id is already exists.")
                ->withInput($input);
        } elseif ((isset($duplicateEmail) && count($duplicateEmail) > 0) || (isset($duplicateMstuser) && count($duplicateMstuser) > 0)) {
        ...
        return redirect('310/users')->with('message', 'User Updated Successfully');
    }
    ...
    public function remove(Request $request)
    {
        ...
        if($delete){
            return redirect('310/users')->with('message', 'User Deleted Successfully');
        }else {
            return redirect('310/users')->with('message', 'Master Users can not be Deleted Permanently');
        }
