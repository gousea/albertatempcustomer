...
class ReceivingOrder extends Model
{
    ...
    public function getReceivingOrder($iroid) 
    {
        ...
        $sql = "SELECT tpod.*, mi.nsellunit, mi.last_costprice,
                            ...
                            mi.dcostprice as dcostprice, mi.dunitprice as dunitprice,mi.ireorderpoint as ireorderpoint, mi.npack as npack,mi.iqtyonhand as total_qtyonhand, 
