...
class Promotion extends Model
{
    ...
    public function addPromotion ($data) 
    {
        ...
        function getSavedItemsAjax($items,$prom_id) {
            ...
            $query = \DB::connection('mysql_dynamic')->select("SELECT (select discounted_price from trn_prom_details where barcode = mi.vbarcode and prom_id = $prom_id limit 1) as new_price, mi.iitemid,mi.vitemcode,mi.vitemname,mi.vbarcode, mi.dcostprice, mi.dunitprice,mi.* FROM mst_item as mi WHERE mi.iitemid = '".$items[0]['iitemid']."' AND mi.estatus='Active'");
