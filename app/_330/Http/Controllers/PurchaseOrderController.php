...
namespace App\_330\Http\Controllers;
...
use App\_330\Model\PurchaseOrder;
...
class PurchaseOrderController extends Controller
{
    ...
    { 
		...
		$data['current_url'] = url('/330/PurchaseOrder');
		$data['add'] = url('/330/PurchaseOrder/add_manual');
		$data['edit'] = url('/330/PurchaseOrder/edit');
		$data['delete'] = url('/330/PurchaseOrder/delete');
		$data['po_sales_history'] = url('/330/PurchaseOrder/add_po_sales_history');
		$data['po_par_level'] = url('/330/PurchaseOrder/add_po_par_level');
		$data['edit_list'] = url('/330/PurchaseOrder/edit_list');
		
        if($order == 'DESC'){
            $data['sort_estatus'] = url('/330/PurchaseOrder?sort=estatus&order=ASC');
            $data['sort_vponumber'] = url('/330/PurchaseOrder?sort=vponumber&order=ASC');
            $data['sort_vvendorname'] = url('/330/PurchaseOrder?sort=vvendorname&order=ASC');
            $data['sort_vordertype'] = url('/330/PurchaseOrder?sort=vordertype&order=ASC');
            $data['sort_dcreatedate'] = url('/330/PurchaseOrder?sort=dcreatedate&order=ASC');
            $data['sort_dreceiveddate'] = url('/330/PurchaseOrder?sort=dreceiveddate&order=ASC');
            $data['sort_LastUpdate'] = url('/330/PurchaseOrder?sort=LastUpdate&order=ASC');
        }else{
            $data['sort_estatus'] = url('/330/PurchaseOrder');
            $data['sort_vponumber'] = url('/330/PurchaseOrder');
            $data['sort_vvendorname'] = url('/330/PurchaseOrder');
            $data['sort_vordertype'] = url('/330/PurchaseOrder');
            $data['sort_dcreatedate'] = url('/330/PurchaseOrder');
            $data['sort_dreceiveddate'] = url('/330/PurchaseOrder');
            $data['sort_LastUpdate'] = url('/330/PurchaseOrder');
        }
		...
		return view('_330.purchase_order.purchase_order_list',compact('data'));
	}
	...
	protected function getSearchList(Request $request) 
    {
        ...
        if(count($query) > 0){
            foreach ($query as $key => $value) {
                ...
                $view_edit = url('/330/PurchaseOrder/edit' . '?ipoid=' . $value->ipoid );
				...
				$temp['delete']         = url('/330/PurchaseOrder/delete' . '?ipoid=' . $value->ipoid );
	...
	public function edit_form(Request $request) 
	{
        ...
        return view('_330.purchase_order.purchase_order_form_manual',compact('data'));
    }
	...
	public function add_po_sales_history(Request $request)
    {
        ...
        return view('_330.purchase_order.purchase_order_form_sales_history',compact('data'));
    }
    ...
    public function add_po_par_level(Request $request)
    {
        ...
        return view('_330.purchase_order.purchase_order_form_par_level',compact('data'));
    }
    ...
    protected function getFormManual($input) 
    {
		...
		if (!isset($input['ipoid'])) {
			$data['action'] = url('/330/PurchaseOrder/add_manual_post');
			
		} else {
			$data['action'] = url('/330/PurchaseOrder/edit_post?ipoid=' . $input['ipoid']);
		}
        
		$data['cancel'] = url('/330/PurchaseOrder');
            
        $data['redirect_edit_url'] = url('/330/PurchaseOrder/redirect_edit_manual');
		$data['get_vendor'] = url('/330/PurchaseOrder/get_vendor');
		$data['get_search_items'] = url('/330/PurchaseOrder/get_search_items');
		$data['check_invoice'] = url('/330/PurchaseOrder/check_invoice');
		$data['purchase_order_list'] = url('/330/PurchaseOrder');
		$data['delete_purchase_order_item'] = url('/330/PurchaseOrder/delete_purchase_order_item');
		$data['save_receive_item'] = url('/330/PurchaseOrder/save_receive_item');
		$data['add_purchase_order_item'] = url('/330/PurchaseOrder/add_purchase_order_item');

		$data['get_search_item_history'] = url('/330/PurchaseOrder/get_search_item_history');
		$data['search_vendor_item_code'] = url('/330/PurchaseOrder/search_vendor_item_code');
		$data['get_item_history'] = url('/330/PurchaseOrder/get_item_history');
		$data['get_item_history_date'] = url('/330/PurchaseOrder/get_item_history_date');
		$data['get_vendor_item'] = url('/330/PurchaseOrder/get_vendor_item');
		$data['get_vendor_item_code_data'] = url('/330/PurchaseOrder/get_vendor_item_code_data');

		$data['check_warehouse_invoice'] = url('administration/transfer/check_invoice');
		
		$data['get_purchase_history'] = url('/330/PurchaseOrder/get_purchase_history');
		$data['export_as_pdf'] = url('/330/PurchaseOrder/export_as_pdf');
		$data['export_as_csv'] = url('/330/PurchaseOrder/export_as_csv');
		$data['export_as_email'] = url('/330/PurchaseOrder/export_as_email');
		$data['export_as_excel'] = url('/330/PurchaseOrder/export_as_excel');
	...
	protected function getFormSalesHistory($input)
	{
        ...
        $data['redirect_edit_url'] = url('/330/PurchaseOrder/redirect_edit_sales_history');
		$data['get_vendor'] = url('/330/PurchaseOrder/get_vendor');
		$data['get_search_items'] = url('/330/PurchaseOrder/get_search_items');
		$data['check_invoice'] = url('/330/PurchaseOrder/check_invoice');
		$data['purchase_order_list'] = url('/330/PurchaseOrder');
        ...
        $data['get_categories_url'] = url('/330/PurchaseOrder/sales_history/get_categories');
        $data['get_subcategories_url'] = url('/330/PurchaseOrder/sales_history/get_subcategories');
        
        $data['get_skus_url'] = url('/330/PurchaseOrder/sales_history/get_skus');
        $data['get_item_names_url'] = url('/330/PurchaseOrder/sales_history/get_item_names');
        $data['get_barcodes_url'] = url('/330/PurchaseOrder/sales_history/get_barcodes');
        $data['get_sizes_url'] = url('/330/PurchaseOrder/sales_history/get_sizes');
        
        $data['post_po_sales_history'] = url('/330/PurchaseOrder/post_po_sales_history');
	...
	protected function getFormParLevel($input)
	{
        ...
        $data['redirect_edit_url'] = url('/330/PurchaseOrder/redirect_edit_par_level');
		$data['get_vendor'] = url('/330/PurchaseOrder/get_vendor');
		$data['get_search_items'] = url('/330/PurchaseOrder/get_search_items');
		$data['check_invoice'] = url('/330/PurchaseOrder/check_invoice');
		$data['purchase_order_list'] = url('/330/PurchaseOrder');
        ...
        $data['get_barcodes_url'] = url('/330/PurchaseOrder/sales_history/get_barcodes');
        $data['get_sizes_url'] = url('/330/PurchaseOrder/sales_history/get_sizes'); 
		$data['search_items'] = url('/330/PurchaseOrder/search');
