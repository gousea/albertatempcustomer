...
use App\_330\Model\ReceivingOrder;
...
class ReceivingOrderController extends Controller
{
    ...
    protected function getList(Request $request) 
    {
		...
		$data['current_url'] = url('/330/ReceivingOrder');
		$data['add'] = url('/330/ReceivingOrder/add');
		$data['edit'] = url('/330/ReceivingOrder/edit');
		$data['delete'] = url('/330/ReceivingOrder/delete');
		$data['edit_list'] = url('/330/ReceivingOrder/edit_list');
        
		$data['import_invoice_new'] = url('/330/ReceivingOrder/import_invoice_new');
		$data['import_missing_items'] = url('/330/ReceivingOrder/import_missing_items');
		$data['get_vendor_data'] = url('/330/ReceivingOrder/get_vendor_data');
		
        if($order == 'DESC'){
            $data['sort_estatus'] = url('/330/330/ReceivingOrder?sort=estatus&order=ASC');
            $data['sort_vponumber'] = url('/330/330/ReceivingOrder?sort=vponumber&order=ASC');
            $data['sort_vvendorname'] = url('/330/330/ReceivingOrder?sort=vvendorname&order=ASC');
            $data['sort_vordertype'] = url('/330/330/ReceivingOrder?sort=vordertype&order=ASC');
            $data['sort_dcreatedate'] = url('/330/330/ReceivingOrder?sort=dcreatedate&order=ASC');
            $data['sort_dreceiveddate'] = url('/330/330/ReceivingOrder?sort=dreceiveddate&order=ASC');
            $data['sort_LastUpdate'] = url('/330/330/ReceivingOrder?sort=LastUpdate&order=ASC');
        }else{
            $data['sort_estatus'] = url('/330/ReceivingOrder');
            $data['sort_vponumber'] = url('/330/ReceivingOrder');
            $data['sort_vvendorname'] = url('/330/ReceivingOrder');
            $data['sort_vordertype'] = url('/330/ReceivingOrder');
            $data['sort_dcreatedate'] = url('/330/ReceivingOrder');
            $data['sort_dreceiveddate'] = url('/330/ReceivingOrder');
            $data['sort_LastUpdate'] = url('/330/ReceivingOrder');
        }
		...
		foreach ($results as $result) {
			...
			$receiving_orders[] = array(
				...
				'view'          => url('/330/ReceivingOrder/info' . '?iroid=' . $result->iroid ),
				'edit'          => url('/330/ReceivingOrder/edit' . '?iroid=' . $result->iroid ),
				'delete'        => url('/330/ReceivingOrder/delete' . '?iroid=' . $result->iroid )
			);
		}
        ...
        if(isset($error_import_barcode) && !empty($error_import_barcode)){
            return view('_330.receiving_orders.receiving_orders_list',compact('data', 'receiving_orders', 'missing_items', 'error_import_barcode'));   
        }
        
		return view('_330.receiving_orders.receiving_orders_list',compact('data', 'receiving_orders', 'missing_items'));
	}
        ...
        if(count($query) > 0){
            foreach ($query as $key => $value) {
                ...
                if($value->estatus == 'Close'){
                    ...
                    $view_edit = url('/330/ReceivingOrder/edit' . '?iroid=' . $value->iroid );
                }else{
                    $view_edit = url('/330/ReceivingOrder/edit' . '?iroid=' . $value->iroid );
                }
                $temp = array();
				...
				$temp['delete']         = url('/330/ReceivingOrder/delete' . '?ipoid=' . $value->iroid );
	...
	public function edit_form(Request $request) 
	{
        ...
        return view('_330.receiving_orders.receiving_order_form',compact('data'));
    }
    ...
    protected function getForm($input) 
    {
		...
		if (!isset($input['iroid'])) {
			$data['action'] = url('/330/ReceivingOrder/add_post');
			
		} else {
			$data['action'] = url('/330/ReceivingOrder/edit_post?iroid=' . $input['iroid']);
		}
        
		$data['cancel'] = url('/330/ReceivingOrder');
		...
		$data['check_invoice'] = url('/330/ReceivingOrder/check_invoice');
		$data['receiving_order_list'] = url('/330/ReceivingOrder');
		$data['delete_receiving_order_item'] = url('/330/ReceivingOrder/delete_receiving_order_item');
		$data['save_receive_item'] = url('/330/ReceivingOrder/save_receive_item');
		$data['add_receiving_order_item'] = url('/330/ReceivingOrder/add_receiving_order_item');

		$data['get_search_item_history'] = url('/330/ReceivingOrder/get_search_item_history');
		$data['search_vendor_item_code'] = url('/PurchaseOrder/search_vendor_item_code');
		$data['get_item_history'] = url('/330/ReceivingOrder/get_item_history');
		$data['get_item_history_date'] = url('/330/ReceivingOrder/get_item_history_date');
		
		$data['check_warehouse_invoice'] = url('/330/ReceivingOrder/transfer/check_invoice');
		
		$data['get_purchase_history'] = url('/330/ReceivingOrder/get_purchase_history');
		$data['get_receiving_history'] = url('/330/ReceivingOrder/get_receiving_history');
