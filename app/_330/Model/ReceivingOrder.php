...
class ReceivingOrder extends Model
{
    ...
    public function getReceivingOrder($iroid) 
    {
        ...
        $sql = "SELECT tpod.*, mi.nsellunit, mi.last_costprice,
                            ...
                            mi.lot_child_limit, mi.lot_npack, mi.vitemtype,
                    ...
                    if(isset($data['items']) && count($data['items']) > 0){
                        ...
                        foreach ($data['items'] as $key => $item) {
                            ...
                            if($item['dunitprice'] != $isItemExist['dunitprice']){
                                ...
                                //=====commented on 17/09/2021 for new lot matrix functionality====
                    ...
                    if($isParentCheck['vitemtype'] == 'Lot Matrix'){
                        ...
                        if(count($itempackexists) > 0){
                            ...
                            foreach($itempackexists as $itempackexist){
                                ...
                                $nunitcost = $isParentCheck['new_costprice']/(int)$isParentCheck['lot_child_limit'];
                                if($nunitcost == ''){
                                    $nunitcost = 0;
                                }
                                ...
                                $unitprice = $itempackexist['npackprice']/(int)$isParentCheck['lot_child_limit'];;
