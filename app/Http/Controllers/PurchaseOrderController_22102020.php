...
class PurchaseOrderController extends Controller
{
	...
	public function search(Request $request) 
	{
        ...
        $show_condition = "WHERE mi.estatus='Active' AND iqtyonhand < ireorderpoint";
        if(isset($input['show_items']) && !empty(trim($input['show_items'])))
        {
            $show_items = trim($input['show_items']);
            if($show_items == "All")
            {
                $show_condition = "WHERE mi.estatus !='' AND iqtyonhand < ireorderpoint";
            }
            else
            {
                $show_condition = "WHERE mi.estatus='".$show_items."' AND iqtyonhand < ireorderpoint";
            }
        ...
        else
        {
            ...
            // $condition .= " AND mi.ireorderpoint < mi.iqtyonhand"; 
            ...
            $count_select_query = "SELECT COUNT(*) as count FROM mst_item as mi 
            ...
            $count_records = $count_total = (int)(int)count($count_query);;
        }
