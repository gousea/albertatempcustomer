...
class EditmultipleController extends Controller
{
    ...
    protected function getList(Request $request) 
    {
        ...
        foreach($data['itemGroups'] as $itemgroup){
            ...
            $itemgroups_html .= "<option value='".$itemgroup['iitemgroupid']."'>".str_replace('"', '', $itemgroup['vitemgroupname'])."</option>";
        }
        ...
        $data['set_pagination_session_url'] = url('/item/edit_multiple_item/a');    
    ...
    public function searchItems(Request $request) 
    {
        ...
        else
        {
           $limit = 20;
            ...
            $items_total_ids = array_column($complete_result, 'iitemid');
            // print_r($items_total_ids); die;
            
            
            // print_r($this->item_id_list);die;
        ...
        // print_r($this->session->data['clicked_pagination']);
    

		// if (($this->request->server['REQUEST_METHOD'] == 'POST') && (!isset($this->session->data['clicked_pagination']) || $this->session->data['clicked_pagination'] !== 1)) {
        //==========commented on 28/03/2020================ 
    ...
    public function add_remove_ids(Request $request) 
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if(isset($session_data)){
                ...
                session()->put('items_total_ids', $new_session_data);
