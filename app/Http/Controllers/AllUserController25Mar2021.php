                ...
                if ($mst_user->vemail != $input['vemail']) {
                    ...
                    if($check_pwd_entered == 1){
                        ...
                        if(count($res) > 0){
                            ...
                            $store_text = '========================== if email else'.PHP_EOL;
                            fwrite($myfile, $store_text);
                        ...
                        session()->forget('userInput');
                            ...
                            $store_text = '========================== mob web else'.PHP_EOL;
                            fwrite($myfile, $store_text);
                    ...
                    if($check_pwd_entered == 1){
                        ...
                        session()->forget('userInput');
                            ...
                            $store_text = '========================== else check pwd entered'.PHP_EOL;
                            fwrite($myfile, $store_text);
                        ...
                        if(count($res) > 0){
                            ...
                            $store_text = '========================== lb_user mob web if'.PHP_EOL;
                            fwrite($myfile, $store_text);
                        ...
                        session()->forget('userInput');
                            ...
                            $store_text = '========================== lb_user mob web else'.PHP_EOL;
                            fwrite($myfile, $store_text);
