...
class HomeController extends Controller
{
    ...
    private function get_dashboard_data($request, $store_id){
        ...
        if(isset($data_curl->error)){
            ...
            $sid = $request->session()->get('sid');
            $trn_sales_query = "SELECT isalesid AS transaction_id, dtrandate as sales_timestamp, ntaxabletotal as sales_amount, vtendertype as tender_type, isalesid FROM u".$sid.".trn_sales limit 100";
 		    $output['trn_sales_data'] = DB::connection()->select($trn_sales_query);  
