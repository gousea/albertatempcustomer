...
class PromotionController extends Controller
{
    ...
    public function savepromotion(Request $req){
       ...
       // $this->load->model('administration/items');
        ...
        $qty_limit = (!is_nan($qty_limit) && ($qty_limit > 0)) ? $qty_limit : 50;
        
        
        $allow_reg_price = $input['qty_limit'] > 0 ? $input['allow_reg_price'] : 'Y';
...
//      }
    ...
    public function insertPromotion ($data) {
        ...
        $allow_reg_price = $input['qty_limit'] > 0?($data['allow_reg_price']):'Y';
