    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-list"></i>Item Audit</h3>
            </div>
       ...
       <div class="panel-body">
        ...
        <div class="panel panel-default">
          <div class="panel-body">
           <form action="{{ route('ItemAuditListForm') }}"  method="GET" id="form_item_search">
              ...
              <div class="row">
                <div class="col-md-3">
                  <input type='text' class="form-control" name="dates" value="<?php echo isset($start_date) ? $start_date : ''; ?>" id="dates" placeholder="Select Date Range" autocomplete="off" readonly/>
                ...
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <input type="submit" name="search_filter" value="Generate" class="btn btn-success align-bottom" style="margin-right:0px">
                      </div>
                    </div>
                 </div>   
              </div>
        ...
        <!-- ================================================== -->
           ...
           <div class="table-responsive private-network-table">
            ...
            <table id="item" class="table table-bordered table-hover dataTables_wrapper no-footer">
