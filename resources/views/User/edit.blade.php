...
@section('main-content')
    ...
    <section class="section-content py-4">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <table data-toggle="table" data-classes="table table-hover table-condensed" data-row-style="rowColors"
                        data-striped="true" data-sort-name="Quality" data-click-to-select="true">
                        <thead>
                            <tr class="">
