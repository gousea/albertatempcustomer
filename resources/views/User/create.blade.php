                    ...
                    <div class="col-md-12 mx-auto">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vphone" maxlength="20" value="{{ old('vphone') }}"
                        ...
                        <div class="form-group row">
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vaddress1" maxlength="75" value="{{ old('vaddress1') }}"
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vaddress2" maxlength="75" value="{{ old('vaddress2') }}"
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vcity" maxlength="25" value="{{ old('vcity') }}"
                        ...
                        <div class="form-group row">
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vstate" maxlength="25" value="{{ old('vstate') }}"
                                    ...
                                    <select name="vusertype" id="input-vusertype" class="form-control" required
                                        ...
                                        @if (isset($mstPermissiongroup))
                                            @foreach ($mstPermissiongroup as $group)
                                                <option value="{{ $group->vgroupname }}" @if ($group->vgroupname == old('vusertype'))
                                                    selected
                        ...
                        <div class="col-md-12 mx-auto">
                            <div class="form-group row">
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        <input type="text" name="ssn" maxlength="25" value="{{ old('ssn') }}"
                                ...
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        <input type="text" name="pay_rate" maxlength="25" value="{{ old('pay_rate') }}"
                            ...
                            <div class="form-group row">
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        ...
                                        // }
                                        ?>
                                        <input type="text" name="start_dt" maxlength="25" value="{{ old('start_dt') }}"
                                ...
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        ...
                                        <input type="text" name="termination_dt" maxlength="25"
                                            value="{{ old('termination_dt') }}" placeholder="TERMINATION DATE"
                        ...
                        <div class="col-md-12 mx-auto">
                            <div class="form-group row">
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form" style="width: 163px; display: none;">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        <input type="text" name="tc_id" maxlength="25" value="" id="input-vuserbarcode"
                                ...
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        <input type="text" name="tc_pass" maxlength="4" value="{{ old('tc_pass') }}"
                                            placeholder="PASSWORD" id="input_tc_pass" class="form-control"
                                            style="width: 163px;" />
                                    </div>
                                </div>
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        <input type="text" name="tcc_pass" maxlength="4" value="{{ old('tcc_pass') }}"
                        ...
                        <div class="col-md-12 mx-auto">
                            <div class="form-group row">
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        <input type="email" name="vemail" maxlength="125" value="{{ old('vemail') }}"
                                ...
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        <input type="text" name="mwpassword" value="{{ old('mwpassword') }}"
                                            placeholder="PASSWORD" id="input-mwpassword" class="form-control webpass"
                                            style="width: 163px;" />
                                        {{-- <input type="text" class="form-control promo-fields" id="p_type"
                                            placeholder="PROMOTION TYPE" name="p_type"> --}}
                                    </div>
                                ...
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        <input type="text" name="re_mwpassword" value="{{ old('re_mwpassword') }}"
                                            placeholder="CONFIRM PASSWORD" id="input-re-mwpassword"
                                            class="form-control webconpass" style="width: 163px;" />
                        ...
                        <div class="col-md-12 mx-auto">
                            <div class="form-group row">
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        <input type="text" name="vuserid" maxlength="3" value="{{ old('vuserid') }}"
                                ...
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        <input type="text" name="vpassword" maxlength="4" value="{{ old('vpassword') }}"
                                            placeholder="PASSWORD" id="input-vpassword" class="form-control pospass"
                                            style="width: 163px;" />
                                        {{-- <input type="text" class="form-control promo-fields" id="p_type"
                                            placeholder="PROMOTION TYPE" name="p_type"> --}}
                                    </div>
                                ...
                                <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                    ...
                                    <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                        <input type="text" name="re_vpassword" maxlength="4"
                                            value="{{ old('re_vpassword') }}" placeholder="CONFIRM PASSWORD"
                                            id="input-re-vpassword" class="form-control posconpass"
                                            style="width: 163px;" />
                                                ...
                                                <td style="height: 49.5px; width: 61.8px;">
                                                    <div class="custom-control custom-checkbox" id="table_green_check"
                                                        ...
                                                        <input
                                                            ...
                                                            value="{{ $permission->vpermissioncode }}"
                                                            {{ in_array($permission->vpermissioncode, old('permission') ?? []) ? 'checked' : '' }}>
                                                    </div>
                                                </td>
                                                <td class="checks_content">
                                                    <span>{{ strtoupper($permission->vdesc) }}</span></td>
                                            </tr>
                                        @endif
                                    @endforeach
                                @endif
                                    ...
                                    @foreach ($permissions as $permission)
                                        @if ($permission->vpermissiontype == 'MOB')
                                            <tr>
                                                ...
                                                <td class="checks_content">
                                                    <span>{{ $permission->vpermissionname }}</span></td>
                                            </tr>
                                        @endif
                                    @endforeach
                                @endif
