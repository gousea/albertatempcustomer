            ...
            <div class="panel-body">
                <div class="row" style="padding-bottom: 9px; padding-left: 10px;">
                    <div class="col-md-12"></div>
                        ...
                        <form name="myForm" action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" id="form-user" class="form-horizontal" >
                            @csrf
                            <div class="container col-md-12">
                                <div class="row col-md-10" id="device_control">
                                    <div class="col-md-12">
...
@section('scripts')
    ...
    <script>
        ...
        if($('.web').prop("checked") == true || $('.mob').prop("checked") == true){
