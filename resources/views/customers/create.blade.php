            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="vfname" maxlength="25" value="{{ old('vfname') }}" placeholder="" id="input-first-name" class="form-control"  onkeypress="return (event.charCode > 64 &&
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input type="text" name="vcity" maxlength="40" value="{{ old('vcity') }}" placeholder="" id="input-city" class="form-control"  onkeypress="" />
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <input type="text" name="vstate" maxlength="40" value="{{ old('vstate') }}" placeholder="" id="input-state" class="form-control"  onkeypress=""  />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group required">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="vphone" maxlength="20"  onkeyup="this.value=this.value.replace(/[^\d]/,'')" value="{{ old('vphone') }}" placeholder="" id="vphone" class="form-control" />
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="id_type" value="{{ old('id_type') }}" placeholder="" id="id_type" class="form-control" />
                    </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="id_number" maxlength="25" value="{{ old('id_number') }}" placeholder="" id="id_number" class="form-control" />
                    </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="expire_dt" value="{{ old('expire_dt') }}" autocomplete="off" placeholder="" id="expire_dt" class="datetimepicker form-control" />
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="birth_dt" value="{{ old('birth_dt') }}" autocomplete="off" placeholder="" id="birth_dt" class="datetimepicker form-control" />
              ...
              <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="account_pin" value="" placeholder="" id="account_pin" class="form-control" onkeypress="return isNumberKey(event);" />
