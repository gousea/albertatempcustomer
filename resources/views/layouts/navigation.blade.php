                ...
                <div class="row">
                        <div class="collapse navbar-collapse" id="main_nav">
                                <ul class="navbar-nav sub">
                                        ...
                                        <li class="nav-item sub-nav"> <a class="nav-link sub text-uppercase" href="{{ route('dashboard') }}">DASHBOARD </a> </li>
                                        @endif
                                        ...
                                        <li class="nav-item sub-nav dropdown">
                                                ...
                                                <ul class="dropdown-menu main-dropdown">
                                                        ...
                                                        <li><a class="dropdown-item sub-dropdown text-uppercase" href="{{ route('store.edit') }}">Store </a></li>
                                                        @endif
