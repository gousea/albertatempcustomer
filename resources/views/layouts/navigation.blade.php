                        ...
                        <li class="nav-item sub-nav dropdown">
                            ...
                            <ul class="dropdown-menu main-dropdown">
                                @if (session()->get('version') == 320)
                                    ...
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ url(session()->get('version') . '/item/item_list/Active/DESC') }}">Items</a>
                                    </li>
                                @else
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                ...
                                @endif
                                <li><a class="dropdown-item sub-dropdown text-uppercase"
                                        href="{{ url('/item/edit_multiple_item') }}">Edit Multiple Items</a>
                                </li>
                                <li><a class="dropdown-item sub-dropdown text-uppercase"
                                        href="{{ route('quick_update_item') }}">Quick Update of Items</a>
                                </li>

                                @if (session()->get('hq_sid') != 1)
                                    <li><a class="dropdown-item sub-dropdown text-uppercase" href="#">Last Modified
                                            Items</a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ url('/item/ItemMovement') }}"> Item Movement </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('ItemAuditList') }}"> Item Audit </a></li>
                                @endif
                                <li><a class="dropdown-item sub-dropdown text-uppercase"
                                        href="{{ route('promotion') }}">Promotions </a></li>
                                <li><a class="dropdown-item sub-dropdown text-uppercase" href="{{ url('buydown') }}">
                                        Buy Down </a></li>
                                <li><a class="dropdown-item sub-dropdown text-uppercase"
                                        href="{{ route('itemgroup') }}"> Item Group </a></li>
                                <li><a class="dropdown-item sub-dropdown text-uppercase"
                                        href="{{ url('/item/quick_item_list') }}"> Quick Item </a></li>
                                <li><a class="dropdown-item sub-dropdown text-uppercase"
                    ...
                    @if (in_array('PER1007', session()->get('userPermsData')))
                        <li class="nav-item sub-nav dropdown">
                            ...
                            <ul class="dropdown-menu main-dropdown">
                                ...
                                <li><a class="dropdown-item sub-dropdown text-uppercase" href="{{ route('unit') }}">
                                        Unit </a></li>
                                <li><a class="dropdown-item sub-dropdown text-uppercase" href="{{ route('size') }}">
                                        Size</a></li>
                                <li><a class="dropdown-item sub-dropdown text-uppercase"
                                ...
                                @if (session()->get('hq_sid') != 1)
                                    ...
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('transfer') }}">Transfer </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase" href="#"> Location </a>
                                    </li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('reason') }}"> Reason </a></li>
                                @endif
                            </ul>
                        </li>
                    @endif
                        ...
                        <li class="nav-item sub-nav dropdown">
                            ...
                            <ul class="dropdown-menu main-dropdown">
                                @if (session()->get('hq_sid') != 1)
                                    ...
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('itemlistdisplay') }}">Item List Display</a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('paidout') }}"> Paid Out </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('aisle') }}"> Aisle </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('shelf') }}">Shelf </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                        ...
                        @if (in_array('PER1009', session()->get('userPermsData')))
                            <li class="nav-item sub-nav dropdown">
                                ...
                                <ul class="dropdown-menu main-dropdown">
                                    ...
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('CardReport') }}"> Credit Card Report </a>
                                    </li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('scan_data_report') }}"> Scan Data Report </a>
                                    </li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('SalesTransaction') }}"> Sales Transaction Report
                                        </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('TaxReport') }}"> Tax Report </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('HourlySalesReport') }}"> Hourly Sales Report </a>
                                    </li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('POReport') }}"> RO History Report </a>
                                    </li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('InventoryReport') }}"> Inventory on Hand Report
                                        </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('ProfitReport') }}"> Profit & Loss Report </a>
                                    </li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('PaidoutReport') }}"> Paid Out Report </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('BelowCostReport') }}"> Below Cost Report </a>
                                    </li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('salesreport') }}"> Sales Report </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('productlisting') }}"> Product Listing </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('employeereport') }}"> Employee Loss Prevention
                                            Report </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('itemsummary') }}"> Item Summary Report </a>
                                    </li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('saleshistoryreport') }}"> Sales History Report </a>
                                    </li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('salesanalyticsreport') }}"> Sales Analytics Report
                                        </a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                            ...
                            <li class="nav-item sub-nav dropdown">
                                ...
                                <ul class="dropdown-menu main-dropdown">
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('itemlistdisplay') }}">Item List Display</a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('end_of_shift_printing') }}"> POS Settings</a></li>
                                    <li><a class="dropdown-item sub-dropdown text-uppercase"
                                            href="{{ route('ftpsetting') }}">FTP</a></li>
                                </ul>
                            </li>
                        @endif
                    @endif
