            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row" style="padding-bottom: 9px;float: right;">
                        <div class="col-md-12">
                            <div class="">
                                {{-- <button type="submit" id="form-vendor" title="" class="btn btn-primary"><i
                                        class="fa fa-save"></i>&nbsp;&nbsp;Save</button>
                                <a href="{{ route('vendors') }}" data-toggle="tooltip" title=""
                    ...
                    <form action="{{ route('vendors.store') }}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vcompanyname" maxlength="50"
                                            value="{{ old('vcompanyname') }}" placeholder="vendor Name"
                                            id="input_vendor_name" class="form-control" required />
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vfnmae" maxlength="25" value="{{ old('vfnmae') }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vcode" maxlength="20" value="{{ old('vcode') }}"
                                            placeholder="" id="input-last-name" class="form-control" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vcity" maxlength="50" value="{{ old('vcity') }}"
                                            placeholder="" id="input-city" class="form-control" onkeypress="cityCheck()" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="text" name="vstate" maxlength="50" value="{{ old('vstate') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vphone" maxlength="20"
                                            ...
                                            value="{{ old('vphone') }}" placeholder="" id="input-phone"
                                            class="form-control" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="email" id="vemail" name="vemail" maxlength="100"
                                            value="{{ old('vemail') }}" placeholder="" class="form-control" />
                                    </div>
                                </div>
                        ...
                        <div id="EDIID" style="background-color:#80808047;">
                            ...
                            <div class="row" style="font-size:12px;">
                                ...
                                <div class="col-sm-2">
                                    <input type="radio" name="vendor_format" value="ALLEN BROTHERS"
                                        style="vertical-align:middle;">
                                    <label for="convert" style="font-weight:normal;"> ALLEN BROTHERS</label>
                                </div>
                                <div class="col-sm-2">
                                    <input type="radio" name="vendor_format" value="CORE MARK"
                                        style="vertical-align:middle;">
                                ...
                                <div class="col-sm-2">
                                    <input type="radio" name="vendor_format" value="OTHERS" style="vertical-align:middle;"
                                        checked>
                            ...
                            <div class="row" style="font-size:12px;">
                                ...
                                <div class="col-sm-2">
                                    <input type="radio" id="upc_convert_E" name="upc_convert" value="E"
                                        style="vertical-align:middle;">
                                    <label style="font-weight:normal;">UPCA -UPCE</label>
                                </div>
                                <div class="col-sm-2">
                                    <input type="radio" id="upc_convert_A" name="upc_convert" value="A"
                                        style="vertical-align:middle;">
                                    <label style="font-weight:normal;">UPCE -UPCA</label>
                                </div>
                                <div class="col-sm-2">
                                    <input type="radio" id="upc_convert_None" name="upc_convert" value="0"
                            ...
                            <div class="row" style="font-size:12px;">
                                ...
                                <div class="col-sm-2">
                                    <input type="checkbox" id="upca_1" class="upca_1" name="remove_first_digit" value="Y"
                                        style="vertical-align:middle;">
                                    <label for="convert" class="upca_1" style="font-weight:normal;"> Remove 1st
                                        Digit</label>
                                </div>
                                <div class="col-sm-2">
                                    <input type="checkbox" id="upca_2" class="upca_2" name="remove_last_digit" value="Y"
                                        style="vertical-align:middle;">
                                    <label for="convert" class="upca_2" style="font-weight:normal;"> Remove Last
                                        Digit</label>
                                </div>
                                <div class="col-sm-2">
                                    <input type="checkbox" id="upca_3" class="upca_3" name="check_digit" value="Y"
                                        style="vertical-align:middle;">
                                    <label for="convert" class="upca_3" style="font-weight:normal;"> With Check
                                        Digit</label>
                                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <span style="color: #03A9F4">(Please Note: If a vendor already exists in any of the stores those vendors
        ...
        $(document).ready(function() {
            ...
            $("#form-vendor").click(function() {
                ...
                if (vcompanyname === " ") {
                    ...
                    if (edi == '1' && vendor_formate == '' || vcompanyname == undefined) {
                        alert('Select Vendor EDI Formate');
                    } else {
                        <?php if(session()->get('hq_sid') == 1){ ?>
                            if($("#vendorForm").valid()){
                                $('#myModal').modal('show');
