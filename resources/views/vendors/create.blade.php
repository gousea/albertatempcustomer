    ...
    <div class="container-fluid">
        <div class="row">
            <div class="collapse navbar-collapse" id="main_nav">
                <div class="menu">
                    <h6 class="font-weight-bold text-uppercase">Add Vendor</h6>
                </div>
                ...
                <form action="{{ route('vendors.store') }}" method="post" enctype="multipart/form-data" id="vendorForm" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                            ...
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                <input type="text" name="vfnmae" maxlength="25" value="{{ old('vfnmae') }}" placeholder="FIRST NAME" id="input-first-name" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                            ...
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                <input type="text" name="vlname" maxlength="25" value="{{ old('vlname') }}" placeholder="LAST NAME" id="input-last-name" class="form-control" />
                            </div>
                        </div>
                        <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                <input type="text" name="vcode" maxlength="20" value="{{ old('vcode') }}" placeholder="VENDOR CODE" id="input-last-name" class="form-control" />
                            </div>
                        </div>
                        <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                <input type="text" name="vaddress1" maxlength="100" value="{{ old('vaddress1') }}" placeholder="ADDRESS" id="input-address" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                            ...
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                <input type="text" name="vcity" maxlength="50" value="{{ old('vcity') }}" placeholder="CITY" id="input-city" class="form-control" onkeypress="cityCheck()" />
                            </div>
                        </div>
                        <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                <input type="text" name="vstate" maxlength="50" value="{{ old('vstate') }}" placeholder="STATE" id="input-state" class="form-control" onkeypress="" />
                            </div>
                        </div>
                        <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                <input type="text" name="vphone" maxlength="20"  onkeyup="this.value=this.value.replace(/[^\d]/,'')" value="{{ old('vphone') }}" placeholder="PHONE" id="input-phone" class="form-control" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                            ...
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                <input type="text" name="vzip" maxlength="10" value="{{ old('vzip') }}" placeholder="ZIP" id="input-zip" class="form-control" />
                            </div>
                        </div>
                        <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                        ...
                        <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                            ...
                            <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                <input type="email"  id="vemail" name="vemail"  maxlength="100" value="{{ old('vemail') }}" placeholder="EMAIL"  class="form-control" />
                            </div>
