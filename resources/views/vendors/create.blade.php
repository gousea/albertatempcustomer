...
@section('main-content')
    <form action="{{ route('vendors.store') }}" method="post" enctype="multipart/form-data" id="vendorForm"
            ...
            <div class="container">
                <div class="collapse navbar-collapse" id="main_nav">
                    ...
                    <div class="nav-submenu">
                        ...
                        <a style="pointer-events:all;" href="{{ route('vendors') }}" data-toggle="tooltip"
                            title="<?php //echo $button_cancel;
                            ?>"
                            class="btn btn-danger buttonred buttons_menu basic-button-small text-uppercase cancel_btn_rotate"><i
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vcompanyname" maxlength="50"
                                        value="{{ old('vcompanyname') }}" placeholder="VENDOR NAME" id="input_vendor_name"
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vcity" maxlength="50" value="{{ old('vcity') }}"
                                        placeholder="CITY" id="input-city" class="form-control" onkeypress="cityCheck()" />
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vzip" maxlength="10" value="{{ old('vzip') }}"
                                        placeholder="ZIP" id="input-zip" class="form-control" />
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="email" id="vemail" name="vemail" maxlength="100"
                                        value="{{ old('vemail') }}" placeholder="EMAIL" class="form-control" />
                                </div>
