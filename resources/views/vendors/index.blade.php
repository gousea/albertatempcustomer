          ...
          <div class="row" style="padding-bottom: 9px;float: right;">
            <div class="col-md-12">
              <div class="">
                ...
                <button type="button" class="btn btn-danger" id="vender_delete" title="Delete" style="border-radius: 0px;"><i class="fa fa-trash"></i>&nbsp;&nbsp;Delete</button>
              </div>
            </div>
          </div>
          ...
          <form action="" method="post" enctype="multipart/form-data" id="form-vendor">
            ...
            <div class="table-responsive">
              <table id="vendor" class="table table-bordered table-hover">
                ...
                <thead>
                  <tr>
                    <th style="width: 1px;" class="text-center"><input type="checkbox" style="background: none !important;"  onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></th>
