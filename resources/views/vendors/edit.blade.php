...
@section('main-content')
    ...
    <form action="{{ route('vendors.update', $vendor->isupplierid) }}" method="post" enctype="multipart/form-data"
        id="vendorForm" class="form-horizontal">
        @csrf
        @method('PATCH')
                    ...
                    <div class="col-md-12 mx-auto">
                        ...
                        <div class="form-group row">
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vcompanyname" maxlength="50"
                                        value="{{ $vendor->vcompanyname }}" placeholder="VENDOR NAME"
                                        id="input-vendor-name" class="form-control" />
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <select name="vvendortype" id="input-vendor-type" class="form-control">
                                        <option value="vendor" {{ $vendor->vvendortype == 'vendor' ? 'selected' : '' }}>
                                            Vendor</option>
                                        <option value="other" {{ $vendor->vvendortype == 'other' ? 'selected' : '' }}>
                                            Other
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vfnmae" maxlength="25" value="{{ $vendor->vfnmae }}"
                        ...
                        <div class="form-group row">
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vlname" maxlength="25" value="{{ $vendor->vlname }}"
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vcode" maxlength="20" value="{{ $vendor->vcode }}"
                                        placeholder="VENDOR CODE" id="input-last-name" class="form-control" />
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vaddress1" maxlength="100" value="{{ $vendor->vaddress1 }}"
                        ...
                        <div class="form-group row">
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vcity" maxlength="50" value="{{ $vendor->vcity }}"
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vstate" maxlength="50" value="{{ $vendor->vstate }}"
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vphone" maxlength="20"
                                        onkeyup="this.value=this.value.replace(/[^\d]/,'')" value="{{ $vendor->vphone }}"
                                        placeholder="PHONE" id="input-phone" class="form-control" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" name="vzip" maxlength="10" value="{{ $vendor->vzip }}"
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="email" name="vemail" maxlength="100" value="{{ $vendor->vemail }}"
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <select name="plcbtype" class="form-control">
                                        <option value="None" {{ $vendor->plcbtype == 'None' ? 'selected' : '' }}>None
                                        </option>
                                        <option value="Schedule A"
                                            {{ $vendor->plcbtype == 'Schedule A' ? 'selected' : '' }}>Schedule A</option>
                                        <option value="Schedule B"
                                            {{ $vendor->plcbtype == 'Schedule B' ? 'selected' : '' }}>Schedule B</option>
                                        <option value="Schedule C"
                                            {{ $vendor->plcbtype == 'Schedule C' ? 'selected' : '' }}>Schedule C</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
            ...
            <div class="container">
                <div id="EDIID">
                    ...
                    <div class="row" style="font-size:12px;">
                        ...
                        <div class="col-sm-2">
                            <input type="radio" style="vertical-align:middle;" name="vendor_format" value="FEDWAY"
                                {{ $vendor->vendor_format == 'FEDWAY' ? 'checked' : '' }}>
                            <label style="font-weight:normal;">FEDWAY</label>
                        </div>
                        <div class="col-sm-2">
                            <input type="radio" style="vertical-align:middle;" name="vendor_format" value="ALLEN BROTHERS"
                                {{ $vendor->vendor_format == 'ALLEN BROTHERS' ? 'checked' : '' }}>
                            <label for="convert" style="font-weight:normal;"> ALLEN BROTHERS</label>
                        </div>
                        <div class="col-sm-2">
                            <input type="radio" style="vertical-align:middle;" name="vendor_format" value="CORE MARK"
                                {{ $vendor->vendor_format == 'CORE MARK' ? 'checked' : '' }}>
                            <label style="font-weight:normal;">CORE MARK</label>
                        </div>

                        <div class="col-sm-2">
                            <input type="radio" style="vertical-align:middle;" name="vendor_format" value="RESNICK"
                                {{ $vendor->vendor_format == 'RESNICK' ? 'checked' : '' }}>
                            <label for="convert" style="font-weight:normal;"> RESNICK</label>
                        </div>

                        <div class="col-sm-2">
                            <input type="radio" style="vertical-align:middle;" name="vendor_format" value="OTHERS"
                                {{ ($vendor->vendor_format != 'ALLEN BROTHERS' && $vendor->vendor_format != 'CORE MARK' && $vendor->vendor_format != 'RESNICK' && $vendor->vendor_format != 'FEDWAY') || $vendor->vendor_format == 'OTHERS' ? 'checked' : '' }}>
                    ...
                    <div class="row" style="font-size:12px;">
                        ...
                        <div class="col-sm-2">
                            <input type="radio" style="vertical-align:middle;" id="upc_convert_E" name="upc_convert"
                                value="E" {{ $vendor->upc_convert == 'E' ? 'checked' : '' }}>
                            <label style="font-weight:normal;">UPCA -UPCE</label>
                        </div>
                        <div class="col-sm-2">
                            <input type="radio" style="vertical-align:middle;" id="upc_convert_A" name="upc_convert"
                                value="A" {{ $vendor->upc_convert == 'A' ? 'checked' : '' }}>
                            <label style="font-weight:normal;">UPCE -UPCA</label>
                        </div>
                        <div class="col-sm-2">
                            <input type="radio" style="vertical-align:middle;" id="upc_convert_None" name="upc_convert"
                                value="0" {{ $vendor->upc_convert == '0' ? 'checked' : '' }}>
                    ...
                    <div class="row" style="font-size:12px;">
                        ...
                        <div class="col-sm-2">
                            <input type="checkbox" style="vertical-align:middle;" id="upca_1" class="upca_1"
                                name="remove_first_digit" value="Y"
                                {{ $vendor->remove_first_digit == 'Y' ? 'checked' : '' }}>
                            <label for="convert" class="upca_1" style="font-weight:normal;"> Remove 1st Digit</label>
                        </div>
                        <div class="col-sm-2">
                            <input type="checkbox" style="vertical-align:middle;" id="upca_2" class="upca_2"
                                name="remove_last_digit" value="Y"
                                {{ $vendor->remove_last_digit == 'Y' ? 'checked' : '' }}>
                            <label for="convert" class="upca_2" style="font-weight:normal;"> Remove Last Digit</label>
                        </div>
                        <div class="col-sm-2">
                            <input type="checkbox" style="vertical-align:middle;" id="upca_3" class="upca_3"
                                name="check_digit" value="Y" {{ $vendor->check_digit == 'Y' ? 'checked' : '' }}>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Select the stores in which you want to add the Vendor:
                        <span style="color: #03A9F4">(Please Note: If a vendor already exists in any of the stores those
                            vendors will be updated)</span>
                    </h6>
