              ...
              <tr style="border-bottom:1px solid #999;">
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0px;">
                  <tr>
                    ...
                    <td width="20%" align="right" style="padding-bottom:5px;">0</td>
                  </tr>
                  ...
                  <tr style="border-top:1px solid #999;border-bottom:1px solid #999;">
                    ...
                    <td width="10%" style="padding-top:5px;padding-bottom:5px;">&nbsp;</td>
                    <td width="20%" align="right" style="padding-top:5px;padding-bottom:5px;">0</td>
                  </tr>
                </table></td>
              </tr>
              <tr style="border-top:1px solid #999;border-bottom:1px solid #999;">
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0px;"><tr>
                            <td width="70%" align="right"><strong>TestCard</strong></td>
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr style="border-bottom:1px solid #999;">
                    ...
                    <td width="10%" align="right" style="padding-top:5px;padding-bottom:5px;">&nbsp;</td>
                    <td width="20%" align="right" style="padding-top:5px;padding-bottom:5px;"></td>
                  </tr>
                </table></td>
              </tr>		  
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0px;display:none;">
                  <tr>
                    <td width="49%" align="left"><strong>Cashier ID : </strong>4</td>
                    <td width="8%">&nbsp;</td>
                    <td width="43%" align="right"><strong>Register : </strong>1036</td>
                  </tr>
                  <tr>
                    <td align="left"><strong>Tender Type : </strong>TestCard</td>
                    <td>&nbsp;</td>
                    <td align="left">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="left"><strong>TRN : </strong>21060310363</td>
                    <td>&nbsp;</td>
                    <td align="left">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="left"><strong>TRN Time : </strong>06-03-2021 02:02 PM</td>
                    <td>&nbsp;</td>
                    <td align="left">&nbsp;</td>
                  </tr>
                </table></td>
