    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="main_nav">
            ...
            <div class="nav-submenu">
                <a type="button" class="btn btn-gray headerblack  buttons_menu text-uppercase" href="{{route('promotion.create')}}"> print time clock
                </a>
            </div>
        </div> <!-- navbar-collapse.// -->
    </div>
        ...
        <ul class="list-group px-5">
            <li class="list-group-item text-center background-main-color">
                <a href="#" class="caret"><i class="fa fa-caret-left fa-2x"></i></a>
                    <span id="week" class="font-weight-bold text-uppercase"> Week of JANUARY 1, 2021 - JANUARY 7, 2021</span> 
    ...
    <div class="container-fluid">
        <table data-toggle="table" data-classes="table promotionview" data-pagination="true">
            ...
            <tbody class="table-body">
                <tr>
                    <th rowspan="2" class="text-center text-uppercase font-weight-bold text-primary">First last name</th>
                    <td>
                        <div>
