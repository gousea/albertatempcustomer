                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" id="div_addl_disc_aply_qty">
                                        <div class="form-group">
                                            <label class="col-sm-4 control-label" for="div_addl_disc_aply_qty">Addl. Discount Apply Quantity Limit</label>
                                            <div class="col-sm-6">
                                                <input type='text' class="form-control" name="addl_disc_apply_qty" autocomplete="off" id="addl_disc_apply_qty" placeholder="Default: 0" value="<?php echo (isset($data['addl_disc_apply_qty'])) ? $data['addl_disc_apply_qty'] : "" ; ?>"/>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        @if(isset($data['mfr_multi_pack']) || isset($data['mfr_promotion']) || isset($data['mfr_disc_amt']) || isset($data['account_loyalty']) || isset($data['coupon_desc']) || isset($data['buydown_desc']) || isset($data['buydown'])  )
                            <div class="row" id="div_advance_options">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="entry_promotion_status"> Advance Options</label>
                                        <div class="col-sm-6">
                        ...
                        <div id="div_for_rjr_scan_data" hidden>
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="required form-group">
                                        <label class="col-sm-4 control-label" for="entry_promotion_status">Advance Options Password:</label>
                                        <div class="col-sm-6">
                                            <input type="password" style="margin-top: 12px" class="form-control" id="advance_options_password" name="advance_options_password">
                                        </div>
                                        <div class="col-md-2">
                                            <input  type="button" style="margin-top: 12px"  id="unlock_feilds" class="btn btn-primary" value="Unlock Feilds">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="entry_promotion_status">Manufacturer Multi-Pack</label>
                                        <div class="col-sm-6">
                                            <input type="text" style="margin-top: 12px" class="form-control" id="manufacturer_multi_pack" name="manufacturer_multi_pack" value="<?php echo (isset($data['mfg_multipack_desc'])) ? $data['mfg_multipack_desc']: ""; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="entry_promotion_status">Coupon Description</label>
                                        <div class="col-sm-6">
                                            <input type="text" style="margin-top: 12px" class="form-control"  <?php echo isset($data['coupon_desc']) ? "readonly" : ""; ?> id="coupon_desc" name="coupon_desc" value="<?php echo (isset($data['coupon_desc']))?$data['coupon_desc']: ""; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="entry_promotion_status">Manufacurer Promotion</label>
                                        <div class="col-sm-6">
                                            <input type="text" style="margin-top: 12px" class="form-control" id="manufacturer_promotion" name="manufacturer_promotion" value="<?php echo (isset($data['mfg_prom_desc']))?$data['mfg_prom_desc']: ""; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="entry_promotion_status">Manufacurer Discount Amount</label>
                                        <div class="col-sm-6">
                                            <input type="text" style="margin-top: 12px" class="form-control" id="manufacturer_disc_amt" name="manufacturer_disc_amt" value="<?php echo (isset($data['mfg_discount']))?$data['mfg_discount']: ""; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="entry_promotion_status">Buy Down Description</label>
                                        <div class="col-sm-6">
                                            <input type="text" style="margin-top: 12px" class="form-control" id="buydown_description" name="buydown_description" value="<?php echo (isset($data['mfg_buydown_desc']))?$data['mfg_buydown_desc']: "" ; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="entry_promotion_status">Account Loyalty</label>
                                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" for="entry_promotion_status">Buy Down</label>
                                        <div class="col-sm-6">
                                            <input type="text" style="margin-top: 12px" class="form-control" id="buydown" name="buydown" value="<?php echo (isset($data['mfg_buydown'])) ? $data['mfg_buydown']: ""; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ '/'.session()->get('version').'/promotion' }}"  data-toggle="tooltip" title="cancel" class="btn btn-default"><i class="fa fa-reply"></i> Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
