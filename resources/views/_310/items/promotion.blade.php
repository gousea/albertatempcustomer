            ...
            <div class="panel-body">
                <div class="row" style="padding-bottom: 15px;">
                    ...
                    <div class="col-md-3 pull-right">
                        <span>
                            <a href="{{ '/'.session()->get('version').'/addpromotion' }}" title="Add New" class="btn btn-primary add_new_btn_rotate"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add New</a> 
...
<script type="text/javascript">
  $(window).load(function() {
    ...
    $(document).ready( function () {
        var search_url = '/'+ {{ session()->get('version') }} +'/searchpromotion';
        search_url = search_url.replace(/&amp;/g, '&');
        
        var edit_url = '/' + {{ session()->get('version') }}  + '/editpromotion';
