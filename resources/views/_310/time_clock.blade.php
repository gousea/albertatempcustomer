    ...
    <div class="container-fluid">
      ...
      <div class="panel panel-default">
        <div class="panel-heading head_title">
          <h3 class="panel-title"> Time Clock<i class="fa fa-list"></i> </h3>
          ...
          <div class="row" style="padding-bottom: 9px;float: right;">
            <div class="col-md-12">
              <div class="">
               ...
               <!--<a href="" class="btn btn-primary add_new_btn_rotate"><i></i>&nbsp;&nbsp;Edit</a>
               <!-- <a href="" class="btn btn-primary add_new_btn_rotate"><i></i>&nbsp;&nbsp;Save</a>-->
                <input type="submit" id="Submit" value="Save" class="btn btn-primary" >
               <a id="pdf_export_btn" href="#" class="btn add_new_btn_rotate button_color"  ><i></i>&nbsp;&nbsp;Publish to Time Sheet</a>
