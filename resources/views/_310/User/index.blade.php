      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row" style="padding-bottom: 9px;float: right;">
            <div class="col-md-12">
              <div class="">
                <a href="{{ url('/310/users/create') }}" class="btn btn-primary add_new_btn_rotate"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add New</a>
        ...
        <form action="#"  id="form_user_search">
         ...
         <br>
         <form action="{{ url('/310/users/remove') }}" method="post" enctype="multipart/form-data" id="form-users">
              ...
              <table id="users" class="table table-bordered table-hover" style="">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="text-right">Cell Number</th>
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr id="users-row">
                            ...
                            <td class="text-left">
                                <a href="{{ url('/310/users/'.$user->iuserid.'/edit' ) }}" title="Edit" class="btn btn-sm btn-info edit_btn_rotate" ><i class="fa fa-pencil">&nbsp;&nbsp;Edit</i>
                                </a>
                            </td>
                        </tr>
                    @endforeach
