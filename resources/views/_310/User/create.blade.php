            ...
            <div class="panel-body">
                <div class="row" style="padding-bottom: 9px; padding-left: 10px;">
                    <div class="col-md-12"></div>
                        ...
                        <form name="myForm" action="{{ url('/310/users/store') }}" method="POST" enctype="multipart/form-data" id="form-user" class="form-horizontal" >
                            @csrf
                            <div class="container col-md-12">
                                <div class="row col-md-12" id="device_control">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2 form-group required" style="padding-left:37px;">
                                        ...
                                        <div class="col-md-3 form-group required" style="padding-left:51px;">
                                            <input type="checkbox" name="lb" value="lb" id="fancy-checkbox-danger" autocomplete="off" class="lb device"  {{ old('lb') ? 'checked' : '' }}  />
                                            <div class="[ btn-group ] required">
                                        ...
                                        <div class="col-md-3 form-group required" style="padding-right:0px;">
                                            <input type="checkbox" name="time" value="time" id="fancy-checkbox-delete" autocomplete="off" class="time device"  {{ old('pos') ? 'checked' : '' }}  />
                                            <div class="[ btn-group ] required">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vfname" maxlength="25" value="{{ old('vfname') }}" placeholder="" id="input-vfname" class="form-control" required onkeypress="return (event.charCode > 64 &&
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vlname" maxlength="25" value="{{ old('vlname') }}" placeholder="" id="input-vlname" class="form-control" required onkeypress="return (event.charCode > 64 &&
                                        event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vaddress1" maxlength="75" value="{{ old('vaddress1') }}" placeholder="" id="input-vaddress1" class="form-control"/>
                            ...
                            <div id="time_start">
                                 <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="email" name="time_email" maxlength="25" value="" placeholder=""  class="form-control" />
                                        </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                             <input type="text" name="ssn" maxlength="25" value="" placeholder="" id="input-vuserbarcode" class="form-control" />
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="over_time" maxlength="25" value="" placeholder="" id="input-vuserbarcode" class="form-control" />
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="pay_rate" maxlength="25" value="" placeholder="" id="input-vuserbarcode" class="form-control" />
                                        </div>
                                        </div>
                                    </div>
                                    <!--<div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="sick_hours" maxlength="25" value="" placeholder="" class="datetimepicker3 form-control"  />
                                        </div>
                                        </div>
                                    </div>
                                   </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" name="start_dt" maxlength="25" value="" placeholder="" id="input_start_dt" class="form-control " />
                                        </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" name="termination_dt" maxlength="25" value="{{ old('vuserbarcode') }}" placeholder="" id="input_termination_dt " class="form-control"  />
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                 <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="vacation_hours" maxlength="25" value="" placeholder=""   class="datetimepicker3 form-control" />
                                        </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <!--<div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="tc_id" maxlength="25" value="" placeholder="" id="input-vuserbarcode" class="form-control" readony/>
                                        </div>
                                        </div>
                                    </div>-->
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="tc_pass" maxlength="4" value="" placeholder="" id="input_tc_pass" class="form-control"/>
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                 ...
                                 <div class="row">
                                  <div class="col-md-6">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="sun_hours" maxlength="25" value="" class="datetimepicker3 form-control" />
                                        </div>
                                        </div>
                                    </div>
                                 </div>   
                                  ...
                                  <div class="col-md-6">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="mon_hours" maxlength="25" value="" placeholder="" class="datetimepicker3 form-control" />
                                        </div>
                                        </div>
                                    </div>
                                 </div>    
                                  ...
                                  <div class="col-md-6">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="tue_hours" maxlength="25" value="" placeholder="" class="datetimepicker3 form-control" />
                                        </div>
                                        </div>
                                    </div>
                                 </div>    
                                  ...
                                  <div class="col-md-6">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="wed_hours" maxlength="25" value="" placeholder="" class="datetimepicker3 form-control" />
                                        </div>
                                        </div>
                                    </div>
                                 </div>    
                                  ...
                                  <div class="col-md-6">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="thu_hours" maxlength="25" value="" placeholder="" class="datetimepicker3 form-control" />
                                        </div>
                                        </div>
                                    </div>
                                 </div>    
                                  ...
                                  <div class="col-md-6">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="fri_hours" maxlength="25" value="" placeholder="" class="datetimepicker3 form-control" />
                                        </div>
                                        </div>
                                    </div>
                                 </div>    
                                  ...
                                  <div class="col-md-6">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="sat_hours" maxlength="25" value="" placeholder="" class="datetimepicker3 form-control" />
                                        </div>
                                        </div>
                                    </div>
                                 </div>    
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="custom-control custom-checkbox" id="table_orange_check">
                                                                    <input type="checkbox" class="checks check custom-control-input" id="customCheck5" name="permission[]" value="{{ $permission->vpermissioncode }}" {{ in_array( $permission->vpermissioncode, old('permission') ?? [] ) ? 'checked' : '' }} >
                                                                </div>
                                                            </td>
