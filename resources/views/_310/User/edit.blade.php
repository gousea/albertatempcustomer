    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row" style="padding-bottom: 9px; padding-left: 10px;">
                    <div class="col-md-12"></div>
                </div>
                        <div class="clearfix"></div>
                        <form name="myForm" action="{{ url('/310/users/update', $users->iuserid) }}" method="POST" enctype="multipart/form-data" id="form-user" class="form-horizontal" >
                            @csrf
                            @method('PATCH')
                            <div class="container col-md-12">
                                <div class="row col-md-12" id="device_control">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2 form-group required" style="padding-left:21px;">
                                        ...
                                        <div class="col-md-3 form-group required" style="padding-left:37px;">
                                            <input type="checkbox" name="lb" value="lb" id="fancy-checkbox-danger" autocomplete="off" class="lb device"
                                        ...
                                        <div class="col-md-3 form-group required" style="padding-left:51px;">
                                            <input type="checkbox" name="time" value="time" id="fancy-checkbox-delete" autocomplete="off" class="time device"  
                                            ...
                                            <div class="[ btn-group ] required">
                                                <label for="fancy-checkbox-delete" class="[ btn btn-success ]">
                                                    <span class="[ glyphicon glyphicon-ok ]"></span>
                                                    <span> </span>
                                                </label>
                                                <label for="fancy-checkbox-delete" class="[ btn btn-default active ]">
                                                    Time Clock
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="row col-md-2" style=" float: right;">
                                    <div class="form-group control_system">
                                        <input type="submit" id="Submit" value="Save" class="btn btn-primary" disabled>
                                        <a href="{{ url('/310/users') }}" data-toggle="tooltip" title="Cancel" class="btn btn-default cancel_btn_rotate"><i class="fa fa-reply"></i>&nbsp;&nbsp;Cancel</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vfname" maxlength="25" value="{{ $users->vfname }}" placeholder="" id="input-vfname" class="form-control" required onkeypress="return (event.charCode > 64 &&
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vlname" maxlength="25" value="{{ $users->vlname }}" placeholder="" id="input-vlname" class="form-control" required  onkeypress="return (event.charCode > 64 &&
                                        event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vaddress1" maxlength="75" value="{{ $users->vaddress1 }}" placeholder="" id="input-vaddress1" class="form-control"/>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vcity" maxlength="25" value="{{ $users->vcity }}" placeholder="" id="input-city" class="form-control" onkeypress="return (event.charCode > 64 &&
                                        event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" />
                                    </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="vstate" maxlength="25" value="{{ $users->vstate }}" placeholder="" id="input-state" class="form-control" onkeypress="return (event.charCode > 64 &&
                                        event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" />
                                    </div>
                                    </div>
                                </div>
                            ...
                            <div id="time_start">
                             <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-vuserbarcode">Email</label>
                                    <div class="col-sm-8">
                                        <input type="email" name="time_email" maxlength="25" value="{{ $users->time_email }}" placeholder=""  class="form-control" />
                                    </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-estatus">SSN</label>
                                    <div class="col-sm-8">
                                         <input type="text" name="ssn" maxlength="25" value="{{ $users->ssn }}" placeholder="" id="input-vuserbarcode" class="form-control" />
                                    </div>
                                    </div>
                                </div>
                            </div>
                             ...
                             <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-vuserbarcode">Pay Type</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-estatus">Overtime</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="over_time" maxlength="25"  value="{{ $users->over_time }}" placeholder="" id="input-vuserbarcode" class="form-control" />
                                    </div>
                                    </div>
                                </div>
                            </div>
                             ...
                             <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-vuserbarcode">Pay Rate</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="pay_rate" maxlength="25" value="{{ $users->pay_rate }}" placeholder="" id="input-vuserbarcode" class="form-control" />
                                    </div>
                                    </div>
                                </div>
                                <!--<div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-estatus">Linked User</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="ssn" maxlength="25" value="{{ old('vuserbarcode') }}" placeholder="" id="input-vuserbarcode" class="form-control" />
                                    </div>
                                    </div>
                                </div>-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-estatus">Sick Hours</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="sick_hours" maxlength="25" value="{{ $users->sick_hours }}" placeholder="" class="datetimepicker3 form-control"  />
                                    </div>
                                    </div>
                                </div>
                               </div>
                             ...
                             <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-vuserbarcode">Start Date</label>
                                    <div class="col-sm-8">
                                        <?php
                                        ...
                                        ?>
                                        <input type="text" name="start_dt" maxlength="25" value="{{ $start_dt ?? '' }}" placeholder="" id="input-start_dt" class="form-control" />
                                    </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <label class="col-sm-4 control-label" for="input-estatus">Termination Date</label>
                                    <div class="col-sm-8">
                                        <?php 
                                        ...
                                        ?>
                                        <input type="text" name="termination_dt" maxlength="25" value="{{ $termination_dt ?? ''}}" placeholder="" id="input-termination_dt" class="form-control" />
                                    </div>
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-vuserbarcode">Vacation Hours</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="vacation_hours" maxlength="25" value="{{ $users->vacation_hours }}" placeholder=""   class="datetimepicker3 form-control" />
                                    </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-vuserbarcode">Time Clock Id</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-estatus">Time Clock Pass</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="tc_pass1" maxlength="4" value="" id="input_tc_pass" class="form-control" />
                                    </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-4 control-label" for="input-vuserbarcode">Avaliable Hours</label>
                                    <div class="col-sm-4">
                             ...
                             <div class="row">
                              <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-6 control-label" for="input-estatus">Sunday</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="sun_hours" maxlength="25" value="{{ $users->sun_hours }}" class="datetimepicker3 form-control" />
                                    </div>
                                    </div>
                                </div>
                             </div>   
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-6 control-label" for="input-estatus">Monday</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="mon_hours" maxlength="25" value="{{ $users->mon_hours }}" class="datetimepicker3 form-control" />
                                    </div>
                                    </div>
                                </div>
                             </div>    
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-6 control-label" for="input-estatus">Tuesday</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="tue_hours" maxlength="25"  value="{{ $users->tue_hours }}" class="datetimepicker3 form-control" />
                                    </div>
                                    </div>
                                </div>
                             </div>    
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-6 control-label" for="input-estatus">Wednesday</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="wed_hours" maxlength="25"  value="{{ $users->wed_hours }}" class="datetimepicker3 form-control" />
                                    </div>
                                    </div>
                                </div>
                             </div>    
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-6 control-label" for="input-estatus">Thursday</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="thu_hours" maxlength="25" value="{{ $users->thu_hours }}" class="datetimepicker3 form-control" />
                                    </div>
                                    </div>
                                </div>
                             </div>    
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-6 control-label" for="input-estatus">Friday</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="fri_hours" maxlength="25" value="{{ $users->fri_hours }}"  class="datetimepicker3 form-control" />
                                    </div>
                                    </div>
                                </div>
                             </div>    
                              ...
                              <div class="col-md-6">
                                    <div class="form-group">
                                    <label class="col-sm-6 control-label" for="input-estatus">Saturday</label>
                                    <div class="col-sm-4">
                                        <input type="text" name="sat_hours" maxlength="25" value="{{ $users->sat_hours }}"  class="datetimepicker3 form-control" />
                                    </div>
                                    </div>
                                </div>
                             </div>    
                            ...
                            <div class="web_mob_form check" id="web_mob">
                                ...
                                <div class="row" id="webmob">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="mwpassword" value="" placeholder="" id="input-mwpassword" class="form-control webpass" />
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="re_mwpassword" value="" placeholder="" id="input-re-mwpassword" class="form-control webconpass" />
                            ...
                            <div class="web_mob_form check" id="pos">
                                ...
                                <div class="row" id="pos">
                                    ...
                                    <div class="col-md-3">
                                            ...
                                            <div class="col-sm-7">
                                                <input type="text" name="vpassword" maxlength="4" value="" placeholder="" id="input-vpassword" class="form-control pospass" />
                                    ...
                                    <div class="col-md-3">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="re_vpassword" maxlength="4" value="" placeholder="" id="input-re-vpassword" class="form-control posconpass" />
...
<script>  
        $(document).ready(function(){
            ...
            var time_set= '<?php echo $users->time_clock; ?>';
            
             if(time_set=='Y') {
                $("#time_start").show(); 
                document.getElementById("Submit").disabled = false;   
                $("#input-mwpassword").removeAttr("required", false);
                $("#input-re-mwpassword").removeAttr("required", false);
             }  
             else{
                $("#time_start").hide(); 
             }
