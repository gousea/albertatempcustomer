    ...
    <div class="container-fluid">
      ...
      <div class="panel panel-default">
        <div class="panel-heading head_title">
          <h3 class="panel-title">PayRoll Report <i class="fa fa-list"></i> </h3>

        </div>
        <br>
         <form method="GET" id="filter_form"  action="{{ route('PayRoll_Report') }}">
             <div class="container">
            <div class="row">
               ...
               <div class="col-md-2">
                    <input type="month" id="By_month" name="By_month">
               </div>
               ...
               <div class="col-md-2">
                    <input type="number" id="Pay_rate" name="Pay_rate">
               </div>
                <div class="col-md-2">
