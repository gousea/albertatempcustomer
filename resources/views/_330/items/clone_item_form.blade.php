          ...
          <div class="row">
              <div class="col-md-12 mx-auto">
                  ...
                  <div class="form-group row">
                      <div class="col-12 col-md-3 col-sm-3 col-lg-3 p-form">
        ...
        <div class="responsive">
          <div class="tab-pane active" id="item_tab">
            <form action="{{ $data['action'] }}" method="post" enctype="multipart/form-data" id="form-item1" class="form-horizontal">
                ...
                <input type="hidden" name="lot_child_limit" value="<?php echo $data['lot_child_limit'];?>">
                              ...
                              <div class="form-group row ">
                                  <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                      ...
                                      <div class="col-6 col-md-6 col-sm-6 col-lg-6 form-group required">
                                        ...
                                        ?>
                                        <input type="text" name="nsellunit" value="<?php if(isset($data['vitemtype']) && $data['vitemtype'] == 'Lot Matrix'){ echo "According to Lot Matrix"; }else{ echo $nsellunit; } ?>" placeholder="Selling Unit" id="input-sellingunit" class="form-control adjustment-fields" <?php if(isset($data['vitemtype']) && $data['vitemtype'] == 'Lot Matrix'){?> readonly <?php } ?> />
