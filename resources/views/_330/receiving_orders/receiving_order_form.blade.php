                                          ...
                                          @endif
                                            ...
                                            <td class="text-right">
                                                @if($item['vitemtype'] == 'Lot Matrix')
                                                    ...
                                                    <input type="hidden" class="lotmatrix_npack" value="<?php echo $item['npack']; ?>">
                                                @else
                                                    <input type="text" class="npackqty_class" name="items[<?php echo $k; ?>][npackqty]" value="<?php echo $item['npackqty']; ?>" id="" style="width:60px;text-align: right;">
                                                @endif
                                            </td>
...
=======
  $(document).on('keyup', '.nordqty_class', function(event) {
    ...
    let vitemtype = $(this).closest('tr').find('.vitemtype_class').val();
    var lotmatrix_npack = $(this).closest('tr').find('.lotmatrix_npack').val();
    ...
    if(vitemtype == 'Lot Matrix'){
        ...
        if(po_order_by == 'case'){
            var closest_itotalunit = nordqty * npackqty*lotmatrix_npack;
        } else {
            var closest_itotalunit = nordqty*lotmatrix_npack;
        }
    }else{
        if(po_order_by == 'case'){
...
>>>>>>> 80b902b7f44a9076ad8df3aeb0d0f1d770273473
      ...
      success: function(result) {
        ...
        if(result.items){
          $.each(result.items, function(index, item) {
            ...
            html_receiving_item += '<td style="width:20%; !important" class="vitemname_class noInput">'+item.vitemname+'<input type="hidden" name="items['+window.index_item+'][vitemname]" value="'+item.vitemname+'"><input type="hidden" class="vitemtype_class" name="items['+window.index_item+'][vitemtype]" value="'+ item.vitemtype +'"></td>';
            ...
            if(item.vitemtype == 'Lot Matrix'){
                html_receiving_item += '<td class="text-right"><input type="text" class="npackqty_class adjustment-fields" name="items['+window.index_item+'][npackqty]" value="'+item.lot_npack+'" id="" style="width:60px;text-align:right;"><input type="hidden" class="lotmatrix_npack" value="'+item.npack+'"></td>';
            }else{
