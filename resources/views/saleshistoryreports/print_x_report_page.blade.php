            ...
            <table class="table <!--table-bordered table-striped --> table-hover">
                    ...
                    <?php if(isset($filters_selected) && $filters_selected == 'NoCategory') { ?>
                        <?php if(isset($r['vdepname'])) { ?>
                            ...
                            <?php foreach($r['details'] as $itmes) { ?>
                                <?php $total_qty_sold += $itmes['totalqty']; $total_total_cost += $itmes['totalCost']; $total_total_price += $itmes['totalPrice'];
                                    $subtotalgrossprofit +=$itmes['totalPrice']-$itmes['totalCost'];
                                    $totalamt = $itmes['totalPrice']*$itmes['totalqty'];
                                ...
                                <tr>
                                    ...
                                    <td class='text-right'><?php echo isset($itmes['totalPrice']) ? $itmes['totalPrice']: ''; ?></td>
                                ...
                                <?php if(isset($cat['vcatname'])) { ?>
                                    ...
                                    <?php  foreach($cat['details'] as $itmes) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td  class='text-right'><?php echo "$", isset($itmes['totalPrice']) ? number_format($itmes['totalPrice'],2): ''; ?></td>
                                            <td  class='text-right'><?php echo number_format((($itmes['totalPrice'] - $itmes['totalCost'])/$itmes['totalPrice'])*100,2),"%"; ?></td>
                ...
                <?php } die;?>
                            ...
                            <br>
                                ...
                                <th> Total:</th>
                                <th class='text-right' id="total_amount"> <?php echo $totalamount1 ; ?> </th>
