                  ...
                  <table id="item" class="table table-bordered table-condensed promotionview" style="width:100%;">
                      ...
                      <thead  class="header-color">
                        ...
                        <tr>
                          ...
                          <th class="text-center" style="vertical-align : middle;">Counted Qty</th>
                          <th class="text-center" style="vertical-align : middle;">Counted Cost</th>
                          <th class="text-center" style="vertical-align : middle;">Counted Price</th>
                          <th class="text-center" style="vertical-align : middle;">Expected Qty<small style="font-size: 8px;">(QOH - Sale)</small></th></th>
                          <th class="text-center" style="vertical-align : middle;">Expected Cost</th>
                          <th class="text-center" style="vertical-align : middle;">Expected Price</th>
                          <th class="text-center" style="vertical-align : middle;">Diff Qty</th>
