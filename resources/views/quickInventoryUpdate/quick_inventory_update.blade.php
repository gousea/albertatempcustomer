    ...
    <div id="content">
        ...
        <div id="upper" class="quickSection">
            @if(session()->has('error_warning'))
                <div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> {{ session()->get('error_warning') }}
            ...
            <div class="panel-body padding-left-right">
                <div class="col-md-5">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="start_dt" maxlength="25" value="" placeholder="DATE" id="start_dt" class="form-control " style="width: 163px;" required="">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="py-3">
                        <div class="row form-inline">
                            <button class="btn btn-primary button-blue buttons_menu basic-button-small" style="width: 44%;" id="bactToItemBtn">BACK TO ITEM SECTION</button>&nbsp&nbsp&nbsp&nbsp
                            <button class="btn btn-primary button-blue buttons_menu basic-button-small" id="finalizeBtn">FINALIZE</button>
                        </div>
                    </div>
                </div>
