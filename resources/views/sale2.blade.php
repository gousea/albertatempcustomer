<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"><div id="content">
            
      <div class="container-fluid">
        <div class="" style="margin-top:0%;">
          <div class="panel-body"> 
            <div class="row">
              <div class="col-md-12" id="printappend"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
              ...
              <tr style="border-bottom:1px solid #999;">
                <td valign="top">
                    <table width="100%" border="0" cellspacing="5" cellpadding="0" style="border-bottom:1px solid #999;">
                      ...
                      <tr style="line-height:25px;">
                        <td width="50%" align="left"><strong>Store Name: </strong>GUNSMOKE AND CONVENIENCE</td>
                        <td width="25%" align="right"><strong>Status</strong></td>
                        <td>&nbsp;&nbsp;Open</td>
                      </tr>
                      <tr style="line-height:25px;">
                        <td width="50%" align="left"><strong>Store Address: </strong>1401 NORTH WASHINGTON</td>
              ...
              <tr style="border-bottom:1px solid #999;">
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0"  style="margin:15px 0px;"><tr><th>Qty</th><th>Pack</th><th>SKU</th><th>Item Name</th><th>Size</th><th>Unit Price</th><th>Total Price</th></tr>
                        ...
                        <tr>
                            <th style="background-color:;">1.00</th>
                            <th style="background-color:;">1</th>
                            <th style="background-color:;">090600061136</th>
                            <th style="background-color:;">PREMIER BLACK-  8OZ</th>
                            <th style="background-color:;">EACH</th>
                            <th style="background-color:;">29.99</th>
                            <th style="background-color:;">29.99</th></b>
                        </tr>
              ...
              <tr style="border-bottom:1px solid #999;">
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0px;">
                  <tr>
                    ...
                    <td width="20%" align="right" style="padding-bottom:5px;">32.98</td>
                  </tr>
                  <tr style="border-top:1px solid #999;">
                    ...
                    <td width="20%" align="right" style="padding-top:5px;padding-bottom:5px;">1.98</td>
                  </tr>
                  <tr style="border-top:1px solid #999;border-bottom:1px solid #999;">
                    ...
                    <td width="10%" style="padding-top:5px;padding-bottom:5px;">&nbsp;</td>
                    <td width="20%" align="right" style="padding-top:5px;padding-bottom:5px;">34.96</td>
                  </tr>
                </table></td>
              </tr>
              <tr style="border-top:1px solid #999;border-bottom:1px solid #999;">
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0px;"><tr>
                            <td width="70%" align="right"><strong>Credit Card</strong></td>
                            <td width="10%" align="right">&nbsp;</td>
                            <td width="20%" align="right">34.96</td>
                          </tr></table></td>
              </tr>
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr style="border-bottom:1px solid #999;">
                    ...
                    <td width="10%" align="right" style="padding-top:5px;padding-bottom:5px;">&nbsp;</td>
                    <td width="20%" align="right" style="padding-top:5px;padding-bottom:5px;">0.00</td>
                  </tr>
                </table></td>
              </tr>		  
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:5px 0px;display:none;">
                  <tr>
                    <td width="49%" align="left"><strong>Cashier ID : </strong>101</td>
                    <td width="8%">&nbsp;</td>
                    <td width="43%" align="right"><strong>Register : </strong>101</td>
                  </tr>
                  <tr>
                    <td align="left"><strong>Tender Type : </strong>Credit Card</td>
                    <td>&nbsp;</td>
                    <td align="left">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="left"><strong>TRN : </strong>21042610167</td>
                    <td>&nbsp;</td>
                    <td align="left">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="left"><strong>TRN Time : </strong>04-26-2021 01:53 PM</td>
                    <td>&nbsp;</td>
                    <td align="left">&nbsp;</td>
                  </tr>
                </table></td>
