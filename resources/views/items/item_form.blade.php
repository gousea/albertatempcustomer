          ...
          <div class="row" id="save_btn_row">
            <div class="col-md-12 text-center">
              ...
              <?php if(isset($data['iitemid']) && $data['iitemid'] != ''){?>
                <button type="button" class="btn btn-danger buttonred buttons_menu basic-button-small" id="delete_btn" style="float: right;"><i class="fa fa-file-text-o"></i>&nbsp;&nbsp;Delete Item</button>
              <?php } ?>
            </div>
          </div>
                      ...
                      <?php foreach($data['itemvendors'] as $k => $itemvendor) { ?>
                        ...
                        <input type="hidden" name="itemvendors[<?php echo $k; ?>][Id]" value="<?php echo $itemvendor->Id; ?>">
                          ...
                          <td class="text-left text-uppercase">
                            <input type="text" class="editable adjustment-fields input_vvendoritemcode" maxlength="100" name="itemvendors[<?php echo $k; ?>][vvendoritemcode]" value="<?php echo $itemvendor->vvendoritemcode; ?>" onclick="$('input[name*=\'selected_vendor_code\']').prop('checked', this.checked);" />
                          </td>
                    ...
                    <div class="row">
                        <div class="col-md-12" id="item_movement_by_date_selection">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input type="button" class="btn btn-success rcorner header-color basic-button-small item_movement_btn" value="GENERATE">
                                </div>
                            </div>
                            <br>
                            <div class="table-responsive">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                  ...
                                  <label for="inputLastname" class="p-2 float-right text-uppercase">Price&nbsp;&nbsp;</label>
                                </div>
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                  ...
                                  <label for="inputLastname" class="p-2 float-right text-uppercase">Level 3 Price</label>
                                </div>
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">

                                  <input type="text" name="nlevel3" value="<?php echo isset($data['nlevel3']) ? $data['nlevel3'] : ''; ?>" placeholder="Level 3 Price" id="tab_input_level3price" class="form-control adjustment-fields" />
                                </div>
                              </div>
                              <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                  ...
                                  <span style="display: inline-block;width: 85%;"><input type="text" name="gross_profit3" value="" placeholder="" id="tab-gross-profit3" class="form-control adjustment-fields" readonly /></span>
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button id="update_btn" class="btn btn-danger buttonred buttons_menu basic-button-small" data-dismiss="modal">Update</button>
    ...
    <div id="aliaModalStores" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button id="alias_save_btn" class="btn btn-danger buttonred buttons_menu basic-button-small" data-dismiss="modal">Save</button>
                <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
              </div>
            </div>
    ...
    <div id="deleteAlaisModal" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button id="delete_alias_btn" class="btn btn-danger buttonred buttons_menu basic-button-small" data-dismiss="modal">Delete</button>
                <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
              </div>
            </div>
    ...
    <div id="lotmatrixModal" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button id="lot_matrix_save_btn" class="btn btn-danger buttonred buttons_menu basic-button-small" data-dismiss="modal">Save</button>
                <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
              </div>
            </div>
    ...
    <div id="editLotMatrixModal" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button id="update_lot_matrix_btn" class="btn btn-danger buttonred buttons_menu basic-button-small" data-dismiss="modal">Update</button>
                <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
              </div>
            </div>
          </div>
            ...
            success: function(data) {
                ...
                for(i=0; i < data.length; i++ ){
                    tableContent += '<tr>'+
                                            '<td>'+
                                                '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                    '<input type="checkbox" class="checks check  vendorstores" id="'+ data[i] +'" name="vendorstores" value="'+ data[i] +'">'+
                                                '</div>'+
                                            '</td>'+
                    ...
                    @foreach (session()->get('stores_hq') as $stores)
                        if(result.includes({{ $stores->id }})){
                            var data = '<tr>'+
                                            '<td>'+
                                                '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                    '<input type="checkbox" class="checks check  vendorstoreAssign" disabled id="hq_sid_{{ $stores->id }}" name="vendorstoreAssign" value="{{ $stores->id }}">'+
                                                '</div>'+
                                            '</td>'+
                                            '<td class="checks_content" style="color:grey"><span>{{ $stores->name }} [{{ $stores->id }}] (Item does not exist)</span></td>'+
                                        '</tr>';
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="text-center"><span style="display: inline-block;"><input type="text" name="percent_selling_price_l2" class="form-control adjustment-fields"></span>&nbsp;<span><b>%</b></span></p>
        <p class="text-center">
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="text-center"><span style="display: inline-block;"><input type="text" name="percent_selling_price_l3" class="form-control adjustment-fields"></span>&nbsp;<span><b>%</b></span></p>
        <p class="text-center">
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="text-center"><span style="display: inline-block;"><input type="text" name="percent_selling_price_l4" class="form-control adjustment-fields"></span>&nbsp;<span><b>%</b></span></p>
        <p class="text-center">
