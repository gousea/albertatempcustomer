    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <ul class="nav nav-tabs responsive" id="myTab">
            ...
            <li id="level_pricing_tab_li"><a href="#level_pricing_tab" data-toggle="tab" >Level Pricing</a></li>
        </ul>
        ...
        <div class="tab-content responsive">
                                    ...
                                    <div class="col-md-8">
                                        <?php if(isset($data['array_yes_no']) && count($data['array_yes_no']) > 0){?>
                                          ...
                                          <?php if($data['wicitem'] == '1') $wicitem = 'Y'; else $wicitem ='N'; ?>
                                            <label class="radio-inline">
                                              <input type="radio" name="wicitem" value="<?php echo $k;?>" <?php if($wicitem == $k) echo "checked"; ?> ><?php echo $array_y_n;?>
                                            </label>
                                          <?php } ?>
                                        <?php } ?>
                                    </div>
          ...
          <div class="tab-pane" id="lot_matrix_tab">
            ...
            <form action="<?php echo $data['lot_matrix_editlist']; ?>" method="post" enctype="multipart/form-data" id="form-item-lot-matrix-list1" class="form-horizontal">
              ...
              <div class="row">
                <div class="col-md-12">
                  <input type="button" title="Update" id="save_pack_edit_index" class="btn btn-primary save_btn_rotate" value="Update" <?php if(isset($data['itempacks']) && count((array)$data['itempacks']) == 0){ ?> disabled="true" <?php } ?> >
                </div>
              </div>
            </form>
          </div>
                    ...
                    <div class="row" style="margin-left:-0px;">
                        <div class="col-md-6">
                            <div class="form-group required">
                                <label class="col-md-4 control-label" for="input-state">Cost</label>
                                <div class="col-md-8">
                                    <input type="text" style="display: inline-block;width: 87%;" value="<?php echo isset($data['new_costprice']) && !empty($data['new_costprice']) ? number_format((float)$data['new_costprice'], 2) : ''; ?>" placeholder="New Cost" id="new_cost" class="form-control" readonly/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group required">
                                <label class="col-md-4 control-label" for="input-state">Price</label>
                                <div class="col-md-8">
                                    <input type="text" style="display: inline-block;width: 87%;" value="<?php echo isset($data['dunitprice']) ? $data['dunitprice'] : ''; ?>" id="dunit_price" class="form-control" readonly/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 padding">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="nlevel2" value="<?php echo isset($data['nlevel2']) ? $data['nlevel2'] : ''; ?>" placeholder="Level 2 Price" id="tab_input_level2price" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 padding">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <span style="display: inline-block;width: 85%;"><input type="text" name="gross_profit2" value="" placeholder="" id="tab-gross-profit2" class="form-control" readonly /></span>
                        ...
                        <div class="row">
                            <div class="col-md-6 padding">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="nlevel3" value="<?php echo isset($data['nlevel3']) ? $data['nlevel3'] : ''; ?>" placeholder="Level 3 Price" id="tab_input_level3price" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 padding">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <span style="display: inline-block;width: 85%;"><input type="text" name="gross_profit3" value="" placeholder="" id="tab-gross-profit3" class="form-control" readonly /></span>
                        ...
                        <div class="row">
                            <div class="col-md-6 padding">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="nlevel4" value="<?php echo isset($data['nlevel4']) ? $data['nlevel4'] : ''; ?>" placeholder="Level 4 Price" id="tab_input_level4price" class="form-control"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 padding">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <span style="display: inline-block;width: 85%;"><input type="text" name="gross_profit4" value="" placeholder="" id="tab-gross-profit4" class="form-control" readonly /></span>
    ...
    <div id="deleteAlaisModal" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
                 ...
                 <table class="table table-bordered">
                    <thead id="table_green_header_tag">
                        <tr>
                            <th>
                                <div class="custom-control custom-checkbox" id="table_green_check">
                                    <input type="checkbox" class="" id="deleteAliasSelectAllCheckbox" name="" value="" style="background: none !important;">
                                </div>
                            </th>
                            <th colspan="2" id="table_green_header">Select All</th>
                        </tr>
              ...
              <div class="modal-footer">
                <button id="delete_alias_btn" class="btn btn-danger" data-dismiss="modal">Delete</button>
                <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
              </div>
            </div>
    ...
    <div id="lotmatrixModal" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
                 ...
                 <table class="table table-bordered">
                    <thead id="table_green_header_tag">
                        <tr>
                            <th>
                                <div class="custom-control custom-checkbox" id="table_green_check">
                                    <input type="checkbox" class="" id="lomatrixSelectAllCheckboxAlias" name="" value="" style="background: none !important;">
                                </div>
                            </th>
                            <th colspan="2" id="table_green_header">Select All</th>
                        </tr>
              ...
              <div class="modal-footer">
                <button id="lot_matrix_save_btn" class="btn btn-danger" data-dismiss="modal">Save</button>
                <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
              </div>
            </div>
    ...
    <div id="editLotMatrixModal" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
                 ...
                 <table class="table table-bordered">
                    <thead id="table_green_header_tag">
                        <tr>
                            <th>
                                <div class="custom-control custom-checkbox" id="table_green_check">
                                    <input type="checkbox" class="" id="editLotMatrixSelectAllCheckbox" name="" value="" style="background: none !important;">
                                </div>
                            </th>
                            <th colspan="2" id="table_green_header">Select All</th>
                        </tr>
              ...
              <div class="modal-footer">
                <button id="update_lot_matrix_btn" class="btn btn-danger" data-dismiss="modal">Update</button>
                <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
              </div>
            </div>
          </div>
                    ...
                    @foreach (session()->get('stores_hq') as $stores)
                        if(result.includes({{ $stores->id }})){
                            var data = '<tr>'+
                                            '<td>'+
                                                '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                    '<input type="checkbox" class="checks check custom-control-input deletealiasstores" disabled id="deletealiasstores" name="deletealiasstores" value="{{ $stores->id }}">'+
                                                '</div>'+
                                            '</td>'+
                            ...
                            var data = '<tr>'+
                                            '<td>'+
                                                '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                    '<input type="checkbox" class="checks check custom-control-input deletealiasstores"  id="deletealiasstores" name="deletealiasstores" value="{{ $stores->id }}">'+
                                                '</div>'+
                                            '</td>'+
                                            '<td class="checks_content" ><span>{{ $stores->name }} [{{ $stores->id }}] </span></td>'+
                                        '</tr>';
    ...
    $("#delete_alias_btn").click(function(){
        ...
        $("input[name='selected_alias[]']:checked").each(function (i)
        {
         ...
         $.ajax({
                ...
                data : JSON.stringify({data, stores_hq:stores_hq_delete_alias }),
                type : 'POST',
                contentType: "application/json",
                dataType: 'json',
                success: function(data) {
  ...
  $(document).on('submit', 'form#add_lot_matrix', function(event) {
    ...
    <?php if(session()->get('hq_sid') == 1){?>
        ...
        $.ajax({
                ...
                data: {iitemid: data['iitemid'] , vbarcode: data['vbarcode']},
                success: function(result){
                    var popup = '';
                    @foreach (session()->get('stores_hq') as $stores)
                        if(result.includes({{ $stores->id }})){
                            var data = '<tr>'+
                                            '<td>'+
                                                '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                    '<input type="checkbox" class="checks check custom-control-input lotstores" disabled id="lotstores" name="lotstores" value="{{ $stores->id }}">'+
                                                '</div>'+
                                            '</td>'+
                                            '<td class="checks_content" style="color:grey"><span>{{ $stores->name }} [{{ $stores->id }}] (Item does not exist)</span></td>'+
                                        '</tr>';
                            ...
                            var data = '<tr>'+
                                            '<td>'+
                                                '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                    '<input type="checkbox" class="checks check custom-control-input lotstores"  id="lotstores" name="lotstores" value="{{ $stores->id }}">'+
                                                '</div>'+
                                            '</td>'+
                                            '<td class="checks_content" ><span>{{ $stores->name }} [{{ $stores->id }}] </span></td>'+
                                        '</tr>';
  ...
  $(document).on('submit', 'form#delete_lot_items', function(event) {
                    ...
                    @foreach (session()->get('stores_hq') as $stores)
                        if(result.includes({{ $stores->id }})){
                            var data = '<tr>'+
                                            '<td>'+
                                                '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                    '<input type="checkbox" class="checks check custom-control-input deletelotstores" disabled id="deletelotstores" name="deletelotstores" value="{{ $stores->id }}">'+
                                                '</div>'+
                                            '</td>'+
                                            '<td class="checks_content" style="color:grey"><span>{{ $stores->name }} [{{ $stores->id }}] (Item does not exist)</span></td>'+
                                        '</tr>';
                            ...
                            var data = '<tr>'+
                                            '<td>'+
                                                '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                    '<input type="checkbox" class="checks check custom-control-input deletelotstores"  id="deletelotstores" name="deletelotstores" value="{{ $stores->id }}">'+
                                                '</div>'+
                                            '</td>'+
                                            '<td class="checks_content" ><span>{{ $stores->name }} [{{ $stores->id }}] </span></td>'+
                                        '</tr>';
    ...
    $("#delete_lot_matrix_btn").click(function(){
        ...
        $.ajax({
            ...
            data : JSON.stringify({data,stores_hq : stores_hq_delete_lot }),
            type : 'POST',
            contentType: "application/json",
            dataType: 'json',
            success: function(data) {
                    ...
                    @foreach (session()->get('stores_hq') as $stores)
                        if(result.includes({{ $stores->id }})){
                            var data = '<tr>'+
                                            '<td>'+
                                                '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                    '<input type="checkbox" class="checks check custom-control-input editlotstores" disabled id="editlotstores" name="editlotstores" value="{{ $stores->id }}">'+
                                                '</div>'+
                                            '</td>'+
                                            '<td class="checks_content" style="color:grey"><span>{{ $stores->name }} [{{ $stores->id }}] (Item does not exist)</span></td>'+
                                        '</tr>';
                            ...
                            var data = '<tr>'+
                                            '<td>'+
                                                '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                    '<input type="checkbox" class="checks check custom-control-input editlotstores"  id="editlotstores" name="editlotstores" value="{{ $stores->id }}">'+
                                                '</div>'+
                                            '</td>'+
                                            '<td class="checks_content" ><span>{{ $stores->name }} [{{ $stores->id }}] </span></td>'+
                                        '</tr>';
                        ...
                        @foreach (session()->get('stores_hq') as $stores)
                            if(result.includes({{ $stores->id }})){
                                var data = '<tr>'+
                                                '<td>'+
                                                    '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                        '<input type="checkbox" class="checks check custom-control-input deleteitemstores" disabled id="deleteitemstores" name="deleteitemstores" value="{{ $stores->id }}">'+
                                                    '</div>'+
                                                '</td>'+
                                                '<td class="checks_content" style="color:grey"><span>{{ $stores->name }} [{{ $stores->id }}] (Item does not exist)</span></td>'+
                                            '</tr>';
                                ...
                                var data = '<tr>'+
                                                '<td>'+
                                                    '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                        '<input type="checkbox" class="checks check custom-control-input deleteitemstores"  id="deleteitemstores" name="deleteitemstores" value="{{ $stores->id }}">'+
                                                    '</div>'+
                                                '</td>'+
                                                '<td class="checks_content" ><span>{{ $stores->name }} [{{ $stores->id }}] </span></td>'+
                                            '</tr>';
                                        ...
                                        @foreach (session()->get('stores_hq') as $stores)
                                            if(result.includes({{ $stores->id }})){
                                                var data = '<tr>'+
                                                                '<td>'+
                                                                    '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                                        '<input type="checkbox" class="checks check custom-control-input itemstores" disabled  id="hq_sid_{{ $stores->id }}" name="itemstores" value="{{ $stores->id }}">'+
                                                                    '</div>'+
                                                                '</td>'+
                                                ...
                                                var data = '<tr>'+
                                                                '<td>'+
                                                                    '<div class="custom-control custom-checkbox" id="table_green_check">'+
                                                                        '<input type="checkbox" class="checks check custom-control-input itemstores"  id="else_hq_sid_{{ $stores->id }}" name="itemstores" value="{{ $stores->id }}">'+
                                                                    '</div>'+
                                                                '</td>'+
                                                                '<td class="checks_content" ><span>{{ $stores->name }} [{{ $stores->id }}] </span></td>'+
                                                            '</tr>';
