            ...
            <div class="collapse navbar-collapse" id="main_nav">
                ...
                <div class="nav-submenu">
                    <a type="button" class="btn btn-dark headerwhite buttons_menu basic-button-small" href="#"> PRINT
                        LABEL </a>
                    <a type="button" class="btn btn-gray headerblack  buttons_menu " href="/addpromotion">
                        ADD NEW
                    </a>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    ...
                                    <label for="inputLastname" class="p-2 float-left text-uppercase">promotion
                                        category</label>
                                </div>
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                    ...
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-12 col-md-4 col-sm-2 col-lg-4 p-form">
                                ...
                                <div class="col-6 col-md-6 col-sm-6 col-lg-6">
                                    <input type="text" class="form-control promo-fields" id="p_type" placeholder="END DATE"
                                        name="p_type">
                                </div>
                            </div>
                        </div>
            ...
            <table data-toggle="table" data-classes="table table-hover table-condensed promotionview"
                ...
                <tbody>
                    <tr id="tr-id-2" class="tr-class-2">
                        <td></td>
                        <td><a href="promotionedit.php">Wheat is a food of indian which grows every where in india of
                                south.</a></td>
                        <td>Good</td>
                        <td>200 Bags</td>
                        <td>Active</td>
