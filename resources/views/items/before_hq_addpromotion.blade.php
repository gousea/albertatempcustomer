                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="required form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="promotion_code" autocomplete="off" id="promotion_code" maxlength="10" value="<?php echo isset($data['prom_id']) ? $data['promotion_code'] : ''; ?>" placeholder="Promotion Code"  class="form-control disabled-text" />
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="required form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type='text' class="form-control" name="qty_limit" autocomplete="off" id="qty_limit" placeholder="Default: 0" value="<?php echo (isset($data['promotion_item_qty_limit']) && $data['promotion_item_qty_limit'] !== null)?$data['promotion_item_qty_limit']:0; ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="required form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="allow_reg_price" id="allow_reg_price" class="form-control" <?php echo (isset($data['promotion_item_qty_limit']) && ($data['promotion_item_qty_limit'] !== null) && ($data['promotion_item_qty_limit'] > 0)) ? '' : 'disabled'; ?> >
                                                    <option value="Y" <?php echo ((isset($allow_reg_price)) && ($allow_reg_price == 'Y')) ? 'selected' : ''?>>Yes</option>
                                                    <option value="N" <?php echo ((isset($allow_reg_price)) && ($allow_reg_price == 'N')) ? 'selected' : ''?>>No</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#item_listing thead tr:eq(1) th').each( function (i) {
            ...
            {
                $(this).html('<select class="form-control" name="category_code" id="category_code" style="width: 90px; padding: 0px; font-size: 9px;"></select>')
            }
